...
from smartem_backend.model.database import Atlas, AtlasTile, AtlasTileGridSquarePosition, GridSquare
...
def grid_square_positions(
    grid_uuid: str, atlas_dir: str, montage_name: str = ""
